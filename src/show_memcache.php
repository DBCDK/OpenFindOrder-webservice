...
function cache_info($status){
  ...
  tr_me("Number of bytes this server is allowed to use for storage.", round($MBSize,4)." Mega Bytes");
$MBSize=(real)( $status["bytes"]/(1024*1024) );
tr_me("Number of bytes currently in storage.",round($MBSize,4)." Mega Bytes");
